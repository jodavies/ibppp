...
namespace parse {
	...
	// error_context characters, whichever happens first. We don't want malformed
	// input to cause huge amounts of data to be printed in the error message.
	inline std::string read_error_context(std::istream& stream) {
